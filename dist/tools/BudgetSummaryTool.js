...
class BudgetSummaryTool extends MCPTool {
    name = "budget_summary";
    description = "Get a summary of the budget highlighting overspent categories that need attention and categories with a positive balance that are doing well.";
    schema = {
        budgetId: {
